    ...
    <head>
        ...
        <style>
            * {{ margin: 0; padding: 0; box-sizing: border-box; }}
            ...
            .info-value {{ color: #111827; font-size: 13px; font-weight: 600; text-align: right; }}
        ...
        <div class="wrapper">
            <div class="card">
                ...
                <div class="footer">
                    ...
                    <p style="margin-top: 8px;">You received this because you have a StoraX account.</p>
                </div>
            </div>
        </div>
    </body>
...
def send_upload_confirmation_email(to_email: str, full_name: str, filename: str, file_size_bytes: float, bucket_name: str):
    ...
    content = f"""
        ...
        <p style="font-size: 13px; color: #6B7280;">Your file is now stored securely in your private bucket and is accessible from your dashboard.</p>
        <div class="divider"></div>
        <div style="text-align: center;">
...
def send_invoice_email(to_email: str, full_name: str, invoice_id: int, total_amount: float,
    ...
    content = f"""
        ...
        <div class="divider"></div>
        <div style="text-align: center;">
            <a href="https://storax-5vt3.vercel.app/billing" class="btn btn-blue">View and Download Invoice →</a>
        </div>
    """
    send_email(
        to_email,
...
def send_storage_warning_email(to_email: str, full_name: str, used_gb: float, limit_gb: float, percent: float):
    ...
    send_email(
        to_email,
        f"StoraX: You have used {percent:.0f}% of your storage",
        _base_template(content)
    )
...
def send_share_notification_email(to_email: str, shared_by: str, filename: str, share_url: str, expires_at: str):
    ...
    send_email(
        to_email,
        f"StoraX: {shared_by} shared a file with you",
        _base_template(content)
    )
